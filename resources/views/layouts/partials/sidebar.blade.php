            ...
            <li class="nav-item">
                ...
                <div id="collapseadmin" class="collapse" aria-labelledby="headingadmin" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Crud Admin</h6>
                        <a class="collapse-item" href="{{ route('admin.index') }}">Tout les Admins</a>
                        <a class="collapse-item" href="{{ route('admin.create') }}">Ajouter un Admin</a>
                    </div>
                </div>
            </li>
